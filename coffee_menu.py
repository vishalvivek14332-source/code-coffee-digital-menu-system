Tkinter GUI can't be launched in this Linux container (no display + libtk missing), which is expected — this is a desktop app for the user's machine. I'll write the file and verify with `py_compile`.
Action: file_editor create /app/coffee_menu.py --file-text "\"\"\"
==============================================================================
 Code & Coffee — Digital Menu System
==============================================================================
 A modern, beginner-friendly Digital Menu System for a coffee shop built with
 Python and Tkinter (ttk). It supports:

    * Categorised menu (Coffee / Tea / Cold Beverages / Snacks / Desserts)
    * Search across menu items
    * Auto-generated colourful placeholder images (no internet required)
    * Live cart with quantity +/- and remove
    * Live order summary (Subtotal, Tax 5%, Grand Total) in INR
    * Place Order -> generates a printable receipt (.txt) and appends the
      order to a CSV log (orders.csv)
    * Pure OOP design, clean comments, and ttk modern styling
...
# Folders that store generated artifacts
RECEIPTS_DIR = \"receipts\"
ORDERS_CSV = \"orders.csv\"

# A pleasant, modern colour palette (coffee themed)
COLORS = {
    \"bg\":            \"#1B1410\",   # dark espresso background
    \"panel\":         \"#241B16\",   # slightly lighter panel
    \"panel_alt\":     \"#2E231C\",
    \"card\":          \"#33271F\",
    \"accent\":        \"#D4A574\",   # latte / caramel
    \"accent_dark\":   \"#A77B4F\",
    \"text\":          \"#F2E8DC\",   # cream text
    \"text_dim\":      \"#B9A99A\",
    \"danger\":        \"#E0654A\",
    \"ok\":            \"#7BB369\",
    \"border\":        \"#4A3A2E\",
...
# Modern font stack — beginner friendly: use a common font that ships with
# most operating systems. We deliberately avoid relying on web fonts here.
FONT_FAMILY = \"Segoe UI\"          # falls back automatically if missing


# -----------------------------------------------------------------------------
# Sample Menu Data
# -----------------------------------------------------------------------------
# Each item dict has: name, price, description, category, color
# The color is used to render a colourful placeholder image tile.

MENU_DATA: List[Dict] = [
    # ---------- Coffee ----------
    {\"name\": \"Espresso\",          \"price\": 120, \"category\": \"Coffee\",
     \"desc\": \"A bold, concentrated shot of pure arabica perfection.\",
     \"color\": \"#6F4E37\"},
    ...
    {\"name\": \"Caffe Latte\",       \"price\": 200, \"category\": \"Coffee\",
     \"desc\": \"Smooth espresso with velvety steamed milk and light foam.\",
     \"color\": \"#C19A6B\"},
    {\"name\": \"Mocha\",             \"price\": 220, \"category\": \"Coffee\",
     \"desc\": \"Espresso, chocolate, and steamed milk — pure indulgence.\",
     \"color\": \"#4B2E2A\"},
    {\"name\": \"Americano\",         \"price\": 150, \"category\": \"Coffee\",
     \"desc\": \"Espresso diluted with hot water for a clean, bold cup.\",
     \"color\": \"#3B2417\"},

    # ---------- Tea ----------
    {\"name\": \"Masala Chai\",       \"price\": 90,  \"category\": \"Tea\",
     \"desc\": \"Classic Indian spiced milk tea, brewed strong and aromatic.\",
     \"color\": \"#C68E5F\"},
    {\"name\": \"Green Tea\",         \"price\": 100, \"category\": \"Tea\",
     \"desc\": \"Light, refreshing, and full of antioxidants.\",
     \"color\": \"#7A9F60\"},
    {\"name\": \"Earl Grey\",         \"price\": 130, \"category\": \"Tea\",
     \"desc\": \"Black tea infused with the citrus aroma of bergamot.\",
     \"color\": \"#6B4423\"},
    {\"name\": \"Lemon Honey Tea\",   \"price\": 110, \"category\": \"Tea\",
     \"desc\": \"Soothing herbal blend with fresh lemon and pure honey.\",
     \"color\": \"#E1B84B\"},

    # ---------- Cold Beverages ----------
    {\"name\": \"Iced Coffee\",       \"price\": 180, \"category\": \"Cold Beverages\",
     \"desc\": \"Chilled black coffee over ice — simple and refreshing.\",
     \"color\": \"#3E2C20\"},
    {\"name\": \"Cold Brew\",         \"price\": 220, \"category\": \"Cold Beverages\",
     \"desc\": \"12-hour slow-steeped coffee. Smooth, low acidity.\",
     \"color\": \"#2A1B12\"},
    {\"name\": \"Iced Latte\",        \"price\": 230, \"category\": \"Cold Beverages\",
     \"desc\": \"Espresso, cold milk, and ice — creamy and refreshing.\",
     \"color\": \"#D7B79A\"},
    {\"name\": \"Frappe\",            \"price\": 260, \"category\": \"Cold Beverages\",
     \"desc\": \"Blended iced coffee with whipped cream and chocolate drizzle.\",
     \"color\": \"#8C5E3C\"},
    {\"name\": \"Fresh Lemonade\",    \"price\": 140, \"category\": \"Cold Beverages\",
     \"desc\": \"Hand-squeezed lemons, a hint of mint, and sparkling water.\",
     \"color\": \"#F2D24B\"},

    # ---------- Snacks ----------
    {\"name\": \"Veg Sandwich\",      \"price\": 160, \"category\": \"Snacks\",
     \"desc\": \"Grilled multigrain with garden veggies and herbed mayo.\",
     \"color\": \"#C8A165\"},
    {\"name\": \"Paneer Wrap\",       \"price\": 200, \"category\": \"Snacks\",
     \"desc\": \"Tandoori paneer rolled in soft tortilla with mint chutney.\",
     \"color\": \"#E07B4A\"},
    ...
    {\"name\": \"Cheese Garlic Bread\",\"price\": 180, \"category\": \"Snacks\",
     \"desc\": \"Toasted bread loaded with mozzarella, garlic, and herbs.\",
     \"color\": \"#D4A45A\"},
    ...
    {\"name\": \"Tiramisu\",          \"price\": 240, \"category\": \"Desserts\",
     \"desc\": \"Italian classic — coffee-soaked sponge with mascarpone cream.\",
     \"color\": \"#A77752\"},
    {\"name\": \"Cheesecake\",        \"price\": 220, \"category\": \"Desserts\",
     \"desc\": \"Creamy New York style cheesecake with a buttery biscuit base.\",
     \"color\": \"#F0D9A8\"},
    {\"name\": \"Red Velvet Pastry\", \"price\": 200, \"category\": \"Desserts\",
     \"desc\": \"Soft red velvet sponge layered with cream cheese frosting.\",
     \"color\": \"#B23A48\"},
]
...
class MenuItem:
    ...
    def item_id(self) -> str:
        \"\"\"A simple, stable id derived from the name.\"\"\"
...
@dataclass
class Cart:
    \"\"\"The shopping cart. Keeps items keyed by item_id for O(1) updates.\"\"\"
...
class PlaceholderImageFactory:
    \"\"\"
    Generates pretty, coloured tile images at runtime with the item's
    initials. No external network/files needed — perfect for offline use.
    \"\"\"
    ...
    def for_item(self, item: MenuItem) -> ImageTk.PhotoImage:
        \"\"\"Return (and cache) a Tk-ready placeholder image for the item.\"\"\"
    ...
    def _lighten(hex_color: str, amount: int) -> tuple:
        \"\"\"Lighten a hex colour by `amount` (0-255) on each channel.\"\"\"
        h = hex_color.lstrip(\"#\")
...
# -----------------------------------------------------------------------------
# Order persistence — Receipt + CSV log
# -----------------------------------------------------------------------------

class OrderWriter:
    \"\"\"Persist completed orders to a .txt receipt and to a CSV log.\"\"\"
    ...
    def save(self, cart: Cart, customer_name: str = \"Guest\") -> Dict:
        \"\"\"Save cart as a receipt + CSV row. Returns metadata dict.\"\"\"
        order_id = self._new_order_id()
        timestamp = datetime.now().strftime(\"%Y-%m-%d %H:%M:%S\")

        receipt_text = self._format_receipt(order_id, timestamp,
                                            cart, customer_name)
...
class MenuItemCard(ttk.Frame):
    \"\"\"A visual card for one menu item: image + name + price + desc + Add.\"\"\"
    ...
    def __init__(self, parent, item: MenuItem,
        ...
        # Image
        self._photo = image_factory.for_item(item)   # keep a reference!
...
class CartLineRow(ttk.Frame):
    \"\"\"A row in the cart panel for a single CartLine.\"\"\"
...
class CoffeeMenuApp(tk.Tk):
    \"\"\"The top-level Tk application window.\"\"\"
    ...
    def _init_styles(self) -> None:
        ...
        # 'clam' allows us to colour ttk widgets reliably across platforms.
        try:
    ...
    def _build_layout(self) -> None:
        ...
        # \"Logo\" — a coloured square with the cafe initials, made with PIL
        logo_img = self._build_logo_image()
        self._logo_ref = logo_img  # keep reference to avoid GC
    ...
    def _make_scrollable(self, parent, bg: Optional[str] = None) -> ttk.Frame:
        \"\"\"Return an inner Frame inside a scrollable Canvas in `parent`.\"\"\"
    ...
    def _install_placeholder(self, entry: ttk.Entry, text: str) -> None:
        \"\"\"Simple placeholder-text behaviour for the search entry.\"\"\"
        entry.insert(0, text)
    ...
    def _build_logo_image(self) -> ImageTk.PhotoImage:
        \"\"\"Generate a tasty little 'C&C' logo tile programmatically.\"\"\"
        size = 64
...
def main() -> None:
    try:
        ...
        # Last-resort error reporting so the user always sees what went wrong.
        try:
...
if __name__ == \"__main__\":
    main()
"
Observation: Create successful: /app/coffee_menu.py